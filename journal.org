...
# Time-stamp: <2022-09-10 16:47:42 krylon>
#
...
* Clock
  ...
  #+CAPTION: Clock summary at [2022-09-10 Sa 16:47]
  | Headline                                     | Time       |           |          |          |      |
  |----------------------------------------------+------------+-----------+----------+----------+------|
  | *Total time*                                 | *7d 13:54* |           |          |          |      |
  |----------------------------------------------+------------+-----------+----------+----------+------|
  | *Theseus [6/11]*                             | *7d 13:54* |           |          |          |      |
  | \_  /Components [10/16]/                     |            | /7d 8:58/ |          |          |      |
  | \_    Recurring Reminders [0/2]              |            |           |     9:24 |          |      |
...
** Components [10/16]
   ...
   :VISIBILITY: children
   :END:
*** MEDITATE Recurring Reminders [0/2]           :internals:feature:database:
    :PROPERTIES:
    :COOKIE_DATA: todo recursive
    :VISIBILITY: children
    :END:
