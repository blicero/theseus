...
# Time-stamp: <2022-08-17 19:35:09 krylon>
#
...
* Clock
  ...
  #+CAPTION: Clock summary at [2022-08-17 Mi 19:35]
  | Headline                  | Time      |           |          |          |
  |---------------------------+-----------+-----------+----------+----------|
  | *Total time*              | *5d 4:34* |           |          |          |
  |---------------------------+-----------+-----------+----------+----------|
  | *Theseus [4/6]*           | *5d 4:34* |           |          |          |
  | \_  /Components [3/5]/    |           | /5d 3:06/ |          |          |
  | \_    Data types          |           |           |     1:04 |          |
  | \_    Database            |           |           |     2:38 |          |
  | \_    Backend [2/3]       |           |           |    23:54 |          |
  | \_      Testing           |           |           |          |     0:35 |
  ...
  | \_    Other sources [0/2] |           |           |  2d 0:22 |          |
  | \_      Framework?        |           |           |          |     3:11 |
  | \_      logreader         |           |           |          | 1d 21:11 |
  | \_  /Cleanup/             |           | /1:28/    |          |          |
  #+END:
* Theseus [4/6]
  :PROPERTIES:
