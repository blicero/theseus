...
# Time-stamp: <2022-08-15 21:19:50 krylon>
#
...
* Clock
  ...
  #+CAPTION: Clock summary at [2022-08-15 Mo 21:19]
  | Headline                  | Time      |            |          |          |
  |---------------------------+-----------+------------+----------+----------|
  | *Total time*              | *5d 1:27* |            |          |          |
  |---------------------------+-----------+------------+----------+----------|
  | *Theseus [4/6]*           | *5d 1:27* |            |          |          |
  | \_  /Components [3/5]/    |           | /4d 23:59/ |          |          |
  | \_    Data types          |           |            |     1:04 |          |
  | \_    Database            |           |            |     2:38 |          |
  | \_    Backend [2/3]       |           |            |    23:54 |          |
  | \_      Testing           |           |            |          |     0:35 |
  ...
  | \_    Other sources [0/2] |           |            | 1d 21:15 |          |
  | \_      Framework?        |           |            |          |     3:11 |
  | \_      logreader         |           |            |          | 1d 18:04 |
  | \_  /Cleanup/             |           | /1:28/     |          |          |
  #+END:
* Theseus [4/6]
  :PROPERTIES:
...
**** TODO Framework?                                   :internals:meditation:
     :LOGBOOK:
