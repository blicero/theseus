...
# Time-stamp: <2022-09-06 21:56:52 krylon>
#
...
* Clock
  ...
  #+CAPTION: Clock summary at [2022-09-06 Di 21:56]
  | Headline                                     | Time      |           |          |          |      |
  |----------------------------------------------+-----------+-----------+----------+----------+------|
  | *Total time*                                 | *7d 6:28* |           |          |          |      |
  |----------------------------------------------+-----------+-----------+----------+----------+------|
  | *Theseus [6/11]*                             | *7d 6:28* |           |          |          |      |
  | \_  /Components [10/16]/                     |           | /7d 1:32/ |          |          |      |
  | \_    Recurring Reminders [0/0]              |           |           |     1:58 |          |      |
  | \_    Data types                             |           |           |     1:04 |          |      |
  | \_    Database                               |           |           |     2:38 |          |      |
...
** Components [10/16]
   ...
   :VISIBILITY: children
   :END:
*** MEDITATE Recurring Reminders [0/0]           :internals:feature:database:
    :PROPERTIES:
    :COOKIE_DATA: todo recursive
    :VISIBILITY: children
    :END:
