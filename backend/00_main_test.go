// /home/krylon/go/src/github.com/blicero/theseus/backend/00_main_test.go
// -*- mode: go; coding: utf-8; -*-
// Created on 02. 07. 2022 by Benjamin Walkenhorst
// (c) 2022 Benjamin Walkenhorst
// Time-stamp: <2022-07-02 18:26:49 krylon>
...
func TestMain(m *testing.M) {
	var (
		err     error
		result  int
		baseDir = time.Now().Format("/tmp/theseus_backend_test_20060102_150405")
	)
